...
""" Fancy indexing : 리스트나 ndrray로 인덱스의 집합을 구성하여 요소를 선택하는
        인덱싱 방식"""
...
# 0, 1행 선택 후 2열을 선택
arrayA1 = array2d[[0, 2], 2]
print('array2d[[0, 2], 2] =>', arrayA1.tolist())
...
""" Boolean indexing : 배열의 요소를 True 혹은 False로 표시하는 Boolean 배열을 생성하고
        이를 인덱스로 사용하여 조건에 만족하는 요소를 선택하거나 조작할 수 있는 인덱싱 방식. """
# 5를 초과하는 요소들만 선택
...
boolean_indexing = np.array([False, False, False, False, False,
                             True, True, True, True])
arrayB2 = array1d[boolean_indexing]
